...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gsap */ \"./node_modules/gsap/index.js\");\n/* harmony import */ var gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! gsap/ScrollTrigger.js */ \"./node_modules/gsap/ScrollTrigger.js\");\n/* harmony import */ var gsap_ScrollToPlugin_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! gsap/ScrollToPlugin.js */ \"./node_modules/gsap/ScrollToPlugin.js\");\n/* harmony import */ var _modules_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/smooth-scroll.js */ \"./src/js/modules/smooth-scroll.js\");\n/* harmony import */ var scroll_lock__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! scroll-lock */ \"./node_modules/scroll-lock/dist/scroll-lock.js\");\n//********************************Импорт модулей***********************************//\r\n\r\n\r\n\r\n\r\n\r\n// import Swiper from 'swiper/bundle';\r\n\r\n\r\ngsap__WEBPACK_IMPORTED_MODULE_3__.gsap.registerPlugin(gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_4__.ScrollTrigger, gsap_ScrollToPlugin_js__WEBPACK_IMPORTED_MODULE_5__.ScrollToPlugin);\r\n\r\n\r\ndocument.addEventListener('DOMContentLoaded', () => {\r\n\r\n\t// Проверка на поддержку webp\r\n\t_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\r\n\t//********************************Глобальные переменные***********************************//\r\n\tconst body = document.querySelector('body');\r\n\tconst viewport = document.querySelector('.viewport');\r\n\tconst header = document.querySelector('.header');\r\n\tconst burger = document.querySelector('.burger');\r\n\tconst wrapper = document.querySelector('.wrapper');\r\n\tconst footer = document.querySelector('.footer');\r\n\tconst menu = document.querySelector('.menu');\r\n\t// const btnToTop = document.querySelector('.btn-to-top');\r\n\t//********************************end Глобальные переменные***********************************//\r\n\r\n\r\n\r\n\t//********************************События***********************************//\r\n\t//Событие клика по документу\r\n\tdocument.addEventListener('click', documentActions);\r\n\t//Событие прокрутки документа\r\n\t// window.addEventListener('scroll', windowScroll);\r\n\t//Событие изменения ширины экрана\r\n\twindow.addEventListener('resize', windowResize);\r\n\t//********************************end События***********************************//\r\n\r\n\r\n\r\n\t//********************************Плавный скролл страниц***********************************//\r\n\r\n\tfunction getSmoothScroll() {\r\n\t\tif (!/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent)) {\r\n\r\n\t\t\tlet scroller = new _modules_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_1__.SmoothScroll({\r\n\t\t\t\ttarget: wrapper,\r\n\t\t\t\tscrollEase: 0.1,\r\n\t\t\t\tmaxOffset: 500\r\n\t\t\t});\r\n\t\t\tbody.classList.add('smooth-off');\r\n\t\t\tviewport.classList.add('smooth-off');\r\n\t\t}\r\n\t\t// else {\r\n\t\t// \tparallaxImage();\r\n\t\t// }\r\n\t}\r\n\r\n\tgetSmoothScroll();\r\n\t//********************************end Плавный скролл страниц***********************************//\r\n\r\n\r\n\r\n\t//********************************Функции для событий***********************************//\r\n\t//Клик\r\n\tfunction documentActions(e) {\r\n\t\tconst targetElement = e.target;\r\n\r\n\t\tif (targetElement.classList.contains('burger')) {\r\n\t\t\ttargetElement.classList.toggle('burger--active');\r\n\t\t\tmenu.classList.toggle('menu--open');\r\n\t\t\theader.classList.toggle('header--open-menu');\r\n\r\n\t\t\tif (!header.classList.contains('header--open-menu')) {\r\n\t\t\t\ttlMenu.reverse();\r\n\t\t\t\t(0,scroll_lock__WEBPACK_IMPORTED_MODULE_2__.enablePageScroll)();\r\n\t\t\t} else {\r\n\t\t\t\ttlMenu.play();\r\n\t\t\t\t(0,scroll_lock__WEBPACK_IMPORTED_MODULE_2__.disablePageScroll)();\r\n\t\t\t}\r\n\t\t}\r\n\t}\r\n\r\n\t//Скролл\r\n\t// function windowScroll() {\r\n\t// }\r\n\r\n\t//Ресайз\r\n\tfunction windowResize() {\r\n\t\tif (window.innerWidth >= 992 && header.classList.contains('header--open-menu')) {\r\n\t\t\theader.classList.remove('header--open-menu');\r\n\t\t\tmenu.classList.remove('menu--open');\r\n\t\t\tburger.classList.remove('burger--active');\r\n\t\t\ttlMenu.reverse();\r\n\t\t\t(0,scroll_lock__WEBPACK_IMPORTED_MODULE_2__.enablePageScroll)();\r\n\t\t}\r\n\t}\r\n\twindowResize();\r\n\t//********************************end Функции для событий***********************************//\r\n\r\n\r\n\r\n\t//********************************Анимации появления секций***********************************//\r\n\t// Появление секций при скролле\r\n\t// const sections = document.querySelectorAll('.section-trigger');\r\n\t// if (sections.length > 0) {\r\n\t// \tsections.forEach((el) => {\r\n\t// \t\tlet elementOffset = el.getBoundingClientRect().top + window.pageYOffset;\r\n\t// \t\tgsap.fromTo(el, {\r\n\t// \t\t\topacity: 0,\r\n\t// \t\t\tx: +400,\r\n\t// \t\t},\r\n\t// \t\t\t{\r\n\t// \t\t\t\topacity: 1,\r\n\t// \t\t\t\tx: 0,\r\n\t// \t\t\t\tscrollTrigger: {\r\n\t// \t\t\t\t\ttrigger: wrapper,\r\n\t// \t\t\t\t\tstart: () => elementOffset - window.innerHeight,\r\n\t// \t\t\t\t\tend: () => elementOffset - (window.innerHeight / 2),\r\n\t// \t\t\t\t\tscrub: true,\r\n\t// \t\t\t\t}\r\n\t// \t\t\t});\r\n\t// \t});\r\n\t// }\r\n\t//********************************end Анимации появления секций***********************************//\r\n\r\n\r\n\r\n\t//********************************Меню***********************************//\r\n\t//Анимация появления\r\n\tconst tlMenu = gsap__WEBPACK_IMPORTED_MODULE_3__.gsap.timeline({ paused: true, });\r\n\ttlMenu.fromTo('.menu', { y: '-100%', opacity: 0, duration: 0.3, }, { y: 0, opacity: 1, })\r\n\t\t.from('.menu__list', { x: '-100%', opacity: 0, duration: 0.5, })\r\n\t\t.from('.menu__contacts-box', { x: '100%', opacity: 0, duration: 0.5, }, \"-=0.5\")\r\n\t\t.from('.menu__line', { x: '-100%', opacity: 0, duration: 0.5, });\r\n\t//********************************end Меню***********************************//\r\n\r\n\r\n\r\n\t//********************************Липкий хедер***********************************//\r\n\tconst tlHeader = gsap__WEBPACK_IMPORTED_MODULE_3__.gsap.timeline({ paused: true });\r\n\r\n\ttlHeader.from('.header', {\r\n\t\tyPercent: -100,\r\n\t\tduration: 0.5\r\n\t}).progress(1);\r\n\r\n\tgsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_4__.ScrollTrigger.create({\r\n\t\ttrigger: wrapper,\r\n\t\tstart: 'top top',\r\n\t\tend: () => footer.offsetTop - window.innerHeight,\r\n\t\tonUpdate: (self) => {\r\n\t\t\tif (!header.classList.contains('open-menu') && !header.classList.contains('open-popup')) {\r\n\t\t\t\tself.direction === -1 ? tlHeader.play() && header.classList.add('header--fixed') : tlHeader.reverse() && header.classList.remove('header--fixed');\r\n\t\t\t\tif (window.pageYOffset == 0) {\r\n\t\t\t\t\theader.classList.remove('header--fixed');\r\n\t\t\t\t\ttlHeader.play();\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t}\r\n\t});\r\n\t//********************************end Липкий хедер***********************************//\r\n\r\n\r\n\r\n\t//********************************Фон footer***********************************//\r\n\tconst footerImages = document.querySelectorAll(\".footer__img\");\r\n\r\n\tfunction repeatOften() {\r\n\t\tconst randomFooterImgIndex = Math.floor(Math.random() * (footerImages.length)) + 0;\r\n\t\tconst randomFooterImg = footerImages[randomFooterImgIndex];\r\n\t\trandomFooterImg.classList.add('footer__img--active');\r\n\r\n\t\tfooterImages.forEach((img) => {\r\n\t\t\tif (img.classList.contains('footer__img--active')) {\r\n\t\t\t\tconst footerColor = img.dataset.color;\r\n\r\n\t\t\t\tfooter.classList.add(footerColor);\r\n\t\t\t}\r\n\t\t});\r\n\t}\r\n\r\n\trepeatOften();\r\n\t//********************************end Фон footer***********************************//\r\n\r\n\r\n\r\n\t//********************************Фон main-hero***********************************//\r\n\tconst mainImgBox = document.querySelector('.main-hero__image-box');\r\n\tconst mainImgArea = document.querySelector('.main-hero__aria');\r\n\r\n\tif (mainImgBox) {\r\n\t\tdocument.onmousemove = function (event) {\r\n\t\t\tlet y = event.y;\r\n\t\t\tlet x = event.x;\r\n\r\n\t\t\tconst distanceTopToImgBox = mainImgBox.getBoundingClientRect().top;\r\n\t\t\tconst distanceLeftToImgBox = mainImgBox.getBoundingClientRect().left;\r\n\t\t\tlet heightImgBox = mainImgBox.offsetHeight;\r\n\t\t\tlet widthImgBox = mainImgBox.offsetWidth;\r\n\t\t\tlet distanceCursorTop = y - distanceTopToImgBox;\r\n\t\t\tlet distanceCursorLeft = x - distanceLeftToImgBox - (widthImgBox / 4);\r\n\r\n\t\t\tif (distanceCursorTop >= 0 && distanceCursorTop <= heightImgBox - 10 && distanceCursorLeft >= 0 && distanceCursorLeft <= widthImgBox) {\r\n\t\t\t\tmainImgArea.style.left = distanceCursorLeft + 'px';\r\n\r\n\t\t\t\tif (window.innerWidth > 768) {\r\n\t\t\t\t\tmainImgArea.style.backgroundPosition = -distanceCursorLeft + 'px ' + 'center';\r\n\t\t\t\t} else {\r\n\t\t\t\t\tmainImgArea.style.backgroundPosition = -distanceCursorLeft + 'px ' + 'top';\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t}\r\n\t}\r\n\t//********************************end Фон main-hero***********************************//\r\n});\n\n//# sourceURL=webpack://start-gulp-2.0/./src/js/script.js?");
